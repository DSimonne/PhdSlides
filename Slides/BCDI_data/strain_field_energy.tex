\begin{frame}{Strain field energy}
    ...
    \begin{columns}
        ...
        \begin{figure}
            ...
            \onslide<2->{\includegraphics[width=0.51\textwidth, clip=True, trim=0 0 19.5cm 0]{Figures/bcdi_data/B7/strain_energy_B-7.png} }\hspace{-0.15cm}
            \onslide<3->{\includegraphics[width=0.48\textwidth, clip=True, trim=20.9cm 0 0 0]{Figures/bcdi_data/B7/strain_energy_B-7.png}}
