\begin{frame}{Pt$_3$O$_4$ surface reconstructions}
    \begin{columns}
    ...
    % \begin{overprint}
        ...
        %     \centering
        %     \includegraphics[width=\textwidth]{Figures/sxrd_data/ctr/reconstruction_ctr_condE.png}
        %     \caption{CTR, peaks at L={0.7, 1.4, 2.1, 2.8} are characteristic of Pt$_3$O$_4$ (red dots). The background shape is linked to xxx. The peaks for the green dots are linked to xxx.}
        %     \label{fig:ctr_conde}
        % \end{figure}
    % \end{overprint}
    ...
    \begin{figure}
        \centering
        % \includegraphics[width=0.9\textwidth, trim={8.5cm 0 3.5cm 0}, clip]{Figures/sxrd_data/maps/Map_hkl_surf_or_1953-1981.png}
